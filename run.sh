...
python main.py --batch_size 16 --model_name "Pythia2.8b" --data "tinystories" --device "mps"
python main.py --batch_size 16 --model_name "Pythia6.9b" --data "tinystories" --device "mps"
python main.py --batch_size 16 --model_name "Pythia12b" --data "tinystories" --device "mps"
...
python main.py --batch_size 16 --model_name "Pythia2.8b" --data "alpaca" --device "mps"
python main.py --batch_size 16 --model_name "Pythia6.9b" --data "alpaca" --device "mps"
python main.py --batch_size 16 --model_name "Pythia12b" --data "alpaca" --device "mps"
...
python main.py --batch_size 16 --model_name "Pythia2.8b" --data "summarisation" --device "mps"
python main.py --batch_size 16 --model_name "Pythia6.9b" --data "summarisation" --device "mps"
python main.py --batch_size 16 --model_name "Pythia12b" --data "summarisation" --device "mps"
