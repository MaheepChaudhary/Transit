    ...
    def activation_embeds_fn(self): # So it contains 5 layers and one last layer. 
        ...
        with t.no_grad():
            for batch in tqdm(self.dataloader):
                ...
                with self.model.trace(batch["input_ids"]) as tracer:
                    output0 = self.model.transformer.h[0].attention.output[0].save()
                    output1 = self.model.transformer.h[1].attention.output[0].save()
                    output2 = self.model.transformer.h[2].attention.output[0].save()
                    output3 = self.model.transformer.h[3].attention.output[0].save()
                    output4 = self.model.transformer.h[4].attention.output[0].save()
                    output5 = self.model.transformer.h[5].attention.output[0].save()
                    output6 = self.model.transformer.h[6].attention.output[0].save()
                    output7 = self.model.transformer.h[7].attention.output[0].save()
                    output8 = self.model.transformer.h[8].attention.output[0].save()
                    output9 = self.model.transformer.h[9].attention.output[0].save()
                    output10 = self.model.transformer.h[10].attention.output[0].save()
                    output11 = self.model.transformer.h[11].attention.output[0].save()
    ...
    def get_grads(self):
        ...
        for batch in tqdm(self.dataloader):
            ...
            with self.model.trace(batch["input_ids"]) as tracer:
                ...
                output0 = self.model.transformer.h[0].attention.output[0].grad.save()
                output1 = self.model.transformer.h[1].attention.output[0].grad.save()
                output2 = self.model.transformer.h[2].attention.output[0].grad.save()
                output3 = self.model.transformer.h[3].attention.output[0].grad.save()
                output4 = self.model.transformer.h[4].attention.output[0].grad.save()
                output5 = self.model.transformer.h[5].attention.output[0].grad.save()
                output6 = self.model.transformer.h[6].attention.output[0].grad.save()
                output7 = self.model.transformer.h[7].attention.output[0].grad.save()
                output8 = self.model.transformer.h[8].attention.output[0].grad.save()
                output9 = self.model.transformer.h[9].attention.output[0].grad.save()
                output10 = self.model.transformer.h[10].attention.output[0].grad.save()
                output11 = self.model.transformer.h[11].attention.output[0].grad.save()
